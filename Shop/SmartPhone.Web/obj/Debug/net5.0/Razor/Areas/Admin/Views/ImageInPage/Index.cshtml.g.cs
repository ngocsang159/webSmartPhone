#pragma checksum "E:\DO_AN\Shop\SmartPhone.Web\Areas\Admin\Views\ImageInPage\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "711ae00a0146051460ddb6dec61a896e79b76ffb"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Areas_Admin_Views_ImageInPage_Index), @"mvc.1.0.view", @"/Areas/Admin/Views/ImageInPage/Index.cshtml")]
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"711ae00a0146051460ddb6dec61a896e79b76ffb", @"/Areas/Admin/Views/ImageInPage/Index.cshtml")]
    public class Areas_Admin_Views_ImageInPage_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            WriteLiteral("\r\n");
#nullable restore
#line 2 "E:\DO_AN\Shop\SmartPhone.Web\Areas\Admin\Views\ImageInPage\Index.cshtml"
...
#nullable restore
#line 76 "E:\DO_AN\Shop\SmartPhone.Web\Areas\Admin\Views\ImageInPage\Index.cshtml"
    ...
    <script>
        $(document).ready(function () {
            ...
            function GetDataTable(pageSize, pageNumber, Search) {
                ...
                $.ajax({
                    url: '/Admin/ImageInPage/_TableView',
                    type: 'post',
                    dataType: 'html',
                    data: {
                        getViewDat");
                WriteLiteral(@"a: getViewData
                    },
            ...
            function RefreshForm() {
                ...
                $('#show-img').attr('src', '/Upload/");
                WriteLiteral(@"Image/no-image.jpg');
            }
            ...
            function ViewDetail() {
                $('.btnDetail').click(function () {
                    ...
                    $.ajax({
                        url: '/Admin/ImageInPage/_ViewDetail',
                        type: 'post',
                        dataType: 'html',
                        data: {
                            Id: Id
            ...
            function SetObjectToForm() {
                ...
                WriteLiteral(@"data-id');
                    $.ajax({
                        url: '/Admin/ImageInPage/GetImageById',
                        type: 'post',
                        dataType: 'json',
                        data: {
                            Id: Id
...
");
                WriteLiteral(@"                                let Id = $(this).attr('data-id');
                                let btn = $(this);
                                $.ajax({
                                    url: '/Admin/ImageInPage/DeleteImageById',
                                    type: 'post',
                                    dataType: 'json',
                                    data: {
                                        Id: Id
            ...
            function AddOrUpdate() {
                $('.btnSave').click(function () {
                    if (CheckValidate()) {
                        let imageInPage = new Object();
                        $('.objInfor input').each(function (index, item) {
                            imageInPage[$(this).attr('name')] = $(this).val();
                        })
                        imageInPage[""Status""] = $('#s1').is(':checked') == 1 ? 1 : 0;
                        // submit data
                        $.ajax({
                            url: '/Admin/ImageInPage/AddOrUpdate',
                            type: 'post',
                            dataType: 'json',
                            data: {
 ...
 ");
            ...
            function CheckValidate() {
             ...
             ");
                WriteLiteral(@"           let title = $(this).siblings('h6').text();
                        $(this).siblings('.text-danger').append(title + ' không được để trống');
                        check++;
                    }
                })
 ...
 ");
                WriteLiteral(@"                   pageSize = $(this).val();
                    let search = $('.searchInput').val().trim();
                    GetDataTable(pageSize, 1, search);
                })
            }
      ...
      ");
                WriteLiteral(@"      function ChooseImage() {
