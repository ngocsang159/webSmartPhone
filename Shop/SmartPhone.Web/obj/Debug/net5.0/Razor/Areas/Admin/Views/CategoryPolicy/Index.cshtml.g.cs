#pragma checksum "E:\DO_AN\Shop\SmartPhone.Web\Areas\Admin\Views\CategoryPolicy\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "2dbd3834a683cb8e09962824632ad311f71301b5"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Areas_Admin_Views_CategoryPolicy_Index), @"mvc.1.0.view", @"/Areas/Admin/Views/CategoryPolicy/Index.cshtml")]
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"2dbd3834a683cb8e09962824632ad311f71301b5", @"/Areas/Admin/Views/CategoryPolicy/Index.cshtml")]
    public class Areas_Admin_Views_CategoryPolicy_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            WriteLiteral("\r\n");
#nullable restore
#line 2 "E:\DO_AN\Shop\SmartPhone.Web\Areas\Admin\Views\CategoryPolicy\Index.cshtml"
  
    ViewData["Title"] = "Quản lý danh mục chính sách  ";
...
#nullable restore
#line 75 "E:\DO_AN\Shop\SmartPhone.Web\Areas\Admin\Views\CategoryPolicy\Index.cshtml"
    ...
    <script>
        $(document).ready(function () {
            ...
            function GetDataTable(pageSize, pageNumber, Search) {
                ...
                $.ajax({
                    url: '/Admin/CategoryPolicy/_TableView',
                    type: 'post',
                    dataType: 'html',
                    data: {
               ");
                WriteLiteral(@"         getViewData: getViewData
                    },
            ...
            function hrefListNew() {
                $('.btnHref').click(function () {
                    ...
                    location.href = ""/Admin/Policy/Index/"" + Id;
                })
            }
          ...
          ");
            ...
            function ViewDetail() {
                $('.btnDetail').click(function () {
                    let Id = $(this).attr('data-id');
                    $.ajax({
                        url: '/Admin/CategoryPolicy/_ViewDetail',
                        type: 'post',
                        dataType: 'html',
                        data: {
                            Id: Id
  ...
  ");
            ...
            function SetObjectToForm() {
                $('.btnEdit').click(function () {
                    let Id = $(this).attr('data-id');
                    $.ajax({
                        url: '/Admin/CategoryPolicy/GetCategoryById',
                        type: 'post',
                        dataType: 'json',
                        data: {
                            Id: Id
       ...
       ");
                WriteLiteral(@"                 text: ""Dữ liệu xóa sẽ không thể khôi phục!"",
                        ...
                        .then((willDelete) => {
                            if (willDelete) {
                                ...
                                let btn = $(this);
                                $.ajax({
                                    url: '/Admin/CategoryPolicy/DeleteById',
                                    type: 'post',
                                    dataType: 'json',
                                    data: {
                                        Id: Id
            ...
            function AddOrUpdate() {
                $('.btnSave').click(function () {
                    if (CheckValidate()) {
                        let CategoryPolicy = new Object();
                        $('.objInfor input').each(function (index, item) {
                            CategoryPolicy[$(this).attr('name')] = $(this).val();
                        })
                        CategoryPolicy[""Status""] = $('#s1').is(':checked') == 1? 1 : 0;
                        // submit data
               ");
                WriteLiteral(@"         $.ajax({
                            url: '/Admin/CategoryPolicy/AddOrUpdate',
                            type: 'post',
                            dataType: 'json',
                            data: {
            ...
            function CheckValidate() {
                ...
                $('.objInfor input').each(function () {
                    ...
                    if (value == '') {
                        check++;
       ");
                WriteLiteral(@"                 let title = $(this).siblings('label').text();
            ...
            function ChangePageNumber() {
                $('.pagination li a').click(function () {
                    page");
                WriteLiteral(@"Number = $(this).attr('data-index');
                ...
                $('#show-img').click(function () {
                    $.ajax({
                        ...
                        success: function (res) {
                            ...
                            if (!$('#m");
                WriteLiteral(@"yModal').hasClass('show')) {
                                $('#myModal').modal('show');
                                ChooseImage();
                            }
