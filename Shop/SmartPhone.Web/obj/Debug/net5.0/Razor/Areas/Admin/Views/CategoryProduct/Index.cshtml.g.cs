#pragma checksum "E:\DO_AN\Shop\SmartPhone.Web\Areas\Admin\Views\CategoryProduct\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "ffc6421dac4f20690b239579b1e82c84f26969e5"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"ffc6421dac4f20690b239579b1e82c84f26969e5", @"/Areas/Admin/Views/CategoryProduct/Index.cshtml")]
...
");
    ...
    ");
                WriteLiteral(@"                                key = key.charAt(0).toUpperCase() + key.substring(1);
         ...
         ");
            ...
            function AddOrUpdate() {
                $('.btnSave').click(function () {
                    if (CheckValidate()) {
                        let categoryProduct = new Object();
     ...
     ");
                WriteLiteral(@"                           let msg = '';
                       ...
                       ");
                WriteLiteral(@"         {
                                    var t = toastr.warning(msgCode);
                                    t.show();

                                }
                                else {
                                    var t = toastr.error(msgf);
                                    t.show();
                                }
                            },
                            error: function (error) {
