...
/*----------------------------------------*/
	...
	$(document).ready(function () {
		...
		$('.category-heading').on('click', function () {
			//	$(".category-heading").siblings(".category-menu-list").addClass('d-none');
			//	let res = $(this).attr('data-show');
			//	if (res == 0) {
			//		$(this).siblings('.category-menu-list').removeClass('d-none');

			//		$(this).attr('data-show', '1');
			//	}
			//	else {
			//		$(this).siblings('.category-menu-list').addClass('d-none');
